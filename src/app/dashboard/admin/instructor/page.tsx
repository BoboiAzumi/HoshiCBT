...
export default function AdminEditorPage(){
    ...
    let [modalNewInstructor, setModalNewInstructor] = useState(false)
                ...
                <div className="flex flex-col">
                    ...
                    <input 
                        ...
                        onChange={(ev) => {
                            setChanged(true)
                            const newInstructorObject = {...newInstructor}
                            newInstructorObject.password = crypto.createHash("sha256").update(ev.target.value).digest("hex")
                            setNewInstructor(newInstructorObject)
                        }}
                    />
                    <h6 className="text-gray-700">Fullname</h6>
                    <input 
                        ...
                        onChange={(ev) => {
                            setChanged(true)
                            const newInstructorObject = {...newInstructor}
                            newInstructorObject.information.fullname = ev.target.value
                            setNewInstructor(newInstructorObject)
                        }}
                    />
                    <h6 className="text-gray-700">Email</h6>
                    <input 
                        ...
                        onChange={(ev) => {
                            setChanged(true)
                            const newInstructorObject = {...newInstructor}
                            newInstructorObject.information.email = ev.target.value
                            setNewInstructor(newInstructorObject)
                        }}
                    />
                    <h6 className="text-gray-700">Phone</h6>
                    <input 
                        ...
                        onChange={(ev) => {
                            setChanged(true)
                            const newInstructorObject = {...newInstructor}
                            newInstructorObject.information.phone = ev.target.value
                            setNewInstructor(newInstructorObject)
                        }}
                    />
                    {changed ? (
                        ...
                        <button className="border border-slate-200 bg-[#ff7854] hover:bg-[#ff4c1a] text-gray-100 mt-5 px-3 py-2 focus:outline-[#ff7854] rounded-md cursor-pointer"
                        onClick={() => setModalNewInstructor(false)}>
                            Close
                        </button>
                    )}
                </div>
                ...
                <div className="w-full z-0">
                    <div className="flex flex-col items-center">
                        ...
                        <button 
                            ...
                            onClick={() => setModalNewInstructor(!modalNewInstructor)}>
                            Add
                        </button>
