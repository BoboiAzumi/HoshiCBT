...
export default function AllowPage(){
    ...
    async function loadUser(){
        const res = await fetch("/api/instructor/class/block/not_in", {
            method: "POST",
            body: JSON.stringify({
                class_id: id,
                q: src
    ...
    async function loadBlockUser(){
        const res = await fetch("/api/instructor/class/block/", {
            method: "POST",
            body: JSON.stringify({
                class_id: id,
            })
    ...
    async function addUser(userid: string){
        const res = await fetch("/api/instructor/class/block/set", {
            method: "POST",
            body: JSON.stringify({
                class_id: id,
                user_id: userid
    ...
    async function deleteUser(userid: string){
        const res = await fetch("/api/instructor/class/block/delete", {
            method: "POST",
            body: JSON.stringify({
                class_id: id,
                user_id: userid
            ...
            <div className={"bg-white w-full min-h-[100vh]"+ (load? " hidden": "")}>
                ...
                <div className="w-full z-0">
                    <div className="flex flex-col items-center">
                        <h2 className="mt-[7.5rem] mb-5 text-2xl font-semibold text-gray-600">Block Users List</h2>
