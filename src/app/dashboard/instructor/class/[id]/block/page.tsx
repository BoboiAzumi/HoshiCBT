...
export default function BlockPage(){
    ...
    let [blockUsers, setBlockUsers] = useState([] as Users[])
    let [src, setSrc] = useState("")
    const { id } = useParams()
    const AddBlockModal = useRef({} as HTMLDialogElement)
                ...
                <div className="modal-box">
                    <>
                        <div className="flex justify-end">
                            <button onClick={(ev) => AddBlockModal.current.close()}>
                                <svg
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="w-[80vw] sm:w-[30rem]">
                            <button
                                className="btn mb-4"
                                onClick={async (ev) => {
                                    AddBlockModal.current.showModal();
                                    await loadUser();
                                }}
                            >
